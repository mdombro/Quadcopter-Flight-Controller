...
//	if (initCount > 0) {
//		initCount--;
//		Orientation_Filter_Update(&Filter, pfGyro, pfAccel, pfMag, 1);
...
//	}
	...
	Orientation_Filter_Update(&Filter, pfGyro, pfAccel, pfMag, 0);
	...
	if (count > 10) {
		...
		//UARTprintf("$%d   %d   %d;\n",  (int)(pfEulers[0]+90.0f),  (int)((pfEulers[1]+90.0f)),  (int)(pfEulers[2]));
		...
		//UARTprintf("$%d %d %d;\n",  (int)(100*(pfEulers[0]+90.0f)),  (int)(10*(pfEulers[1]+90.0f)),  (int)(100*pfEulers[2]));
		//UARTprintf("%d  %d  %d  %d\n", (int)(100*Filter.qAccel[0]), (int)(100*Filter.qAccel[1]), (int)(100*Filter.qAccel[2]), (int)(100*Filter.qAccel[3]));

		//UARTprintf("qMag: %10d  %10d  %10d  %10d qAccel: %10d  %10d  %10d  %10d\n", (int)(100*Filter.qMag[0]), (int)(100*Filter.qMag[1]), (int)(100*Filter.qMag[2]), (int)(100*Filter.qMag[3]),(int)(100*Filter.qAccel[0]), (int)(100*Filter.qAccel[1]), (int)(100*Filter.qAccel[2]), (int)(100*Filter.qAccel[3]));
		...
		//UARTprintf("%d,%d,%d\n", (int)(Filter.roll*1e7), (int)(Filter.pitch*1e7), (int)(Filter.yaw*1e7));

		//UARTprintf("Correction vector: %6d   %6d   %6d\n", (int)(Filter.accelCorrection[0]*1e4), (int)(Filter.accelCorrection[1]*1e4), (int)(Filter.accelCorrection[2]*1e4));
		//UARTprintf("Rotated accel: %6d   %6d   %6d\n", (int)(Filter.rotatedaccel[0]*1e4), (int)(Filter.rotatedaccel[1]*1e4), (int)(Filter.rotatedaccel[2]*1e4));
		//IntMasterEnable();
	}
}
...
main(void)
{
    ...
    //
    g_sMPU9150Inst.pui8Data[0] = 0x19;
    ...
    //
    g_sMPU9150Inst.pui8Data[0] = MPU9150_CONFIG_DLPF_CFG_260_256;
