 ...
 ***************************************************************************/
void PID_Make(PID *pid, float* Input, float* Output, float* Setpoint,
 ...
 ******************************************************************************/
float GetKp(PID *pid){ return  pid->dispKp; }
float GetKi(PID *pid){ return  pid->dispKi;}
float GetKd(PID *pid){ return  pid->dispKd;}
int GetMode(PID *pid){ return  pid->inAuto ? AUTOMATIC : MANUAL;}
int GetDirection(PID *pid){ return pid->controllerDirection;}
